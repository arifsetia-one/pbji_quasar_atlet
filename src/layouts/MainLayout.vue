<template>
  ...
  <section
    id="navbar"
    class="hidden md:flex justify-between items-center p-3 bg-white shadow-md"
  >
    <div class="flex items-center gap-1">
      <img class="w-11" src="../assets/icon/logo.png" alt="" />
    ...
    <nav class="bg-white border-gray-200">
      ...
      >
        <a href="#" class="flex items-center">
          <img src="../assets/icon/logo.png" class="h-8 mr-3" alt="Logo PBJI" />
  ...
  <div>
    ...
    >
      ...
      <div
        class="bg-neutral-200 p-6 text-center font-sans font-semibold dark:bg-neutral-700"
      >
